...
userRouter.get('/', passport_1.default.authenticate('jwt', { session: false }), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const id = user.id;
    const products = yield service.findUser(15);
    res.json(products);
}));
